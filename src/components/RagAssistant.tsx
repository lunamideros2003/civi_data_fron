...
export default function RagAssistant({ variant = 'inline' }: RagAssistantProps) {
		...
		<>
			...
			<div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-white/5">
				<div className="flex items-center gap-2">
					...
					<div>
						<h3 className="font-bold text-sm text-white">Asistente CiviData</h3>
			...
			{/* Input */}
			<form onSubmit={handleSubmit} className="p-3 border-t border-white/10 bg-black/20 mt-auto">
	...
	if (variant === 'inline') {
		return (
			<div className="w-full h-[500px] bg-brand-dark/95 backdrop-blur-xl border border-white/10 rounded-2xl flex flex-col shadow-2xl overflow-hidden">
				{chatContent}
			</div>
		);
	}
